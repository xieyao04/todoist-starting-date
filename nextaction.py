...
class Item(object):
  def __init__(self, initial_data):
    ...
    self.date_string = initial_data['date_string']
    self.due_date = initial_data['due_date']
  ...
  def GetProjectMods(self):
    ...
    for project in self._projects.itervalues():
      ...
      for item in state.remove_labels:
        ...
        item.date_string = ''
        item.due_date = None
        item.due_date_utc = None
        m['args']['labels'] = item.labels
        m['args']['date_string'] = item.date_string
        m['args']['due_date'] = item.due_date
        m['args']['due_date_utc'] = item.due_date_utc
    '''
